...
entropy_list_cost = []
entropy_list_backward = []

# optimization begins
for n in range(steps):
    opt.zero_grad()
    loss = cost_fn(params)
    entropy_list_cost.append(entanglement_entropy(dev.state))
    loss.backward()
    entropy_list_backward.append(entanglement_entropy(dev.state))
    opt.step()
...
entropy_list_cost = np.array(entropy_list_cost)
entropy_list_backward = np.array(entropy_list_backward)

plt.plot(entropy_list_cost.real)
plt.plot(entropy_list_backward.real)
plt.show()
# plt.plot(entropy_list_cost.imag)
# plt.plot(entropy_list_backward.imag)
# plt.show()
print(entropy_list_cost)
print(entropy_list_backward)
